...
with DAG(
    dag_id="ex_4_expand_kwargs_dag_local",
    start_date=datetime(2022, 10, 1),
    schedule=None,
    tags=["exercise_4", "dynamic_tasks", "task", "local"],
    catchup=False
):
    ...
    def create_copy_arg(filename):
        """Add your code here to copy all txt files into /include/ex_4/txt and 
        all yml files into /include/ex_4/yml without changing any other code."""
